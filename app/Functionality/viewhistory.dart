...
Future<List<dynamic>> fetchFacultyAttendanceHistory(String email) async {
  final url = Uri.parse('http://device-ip:3001/fetchfacultyattendancehistory?email=$email');
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: DataTable(
                        ...
                        rows: _data.where((row) {
                          ...
                          return (startDate == '2000-01-01' || date.isAfter(startDate)) &&
                              (endDate == '2100-12-01' || date.isBefore(endDate));
                        })
                            .map((row) {
                          return DataRow(
                            cells: [
